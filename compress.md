...
# 环境
    ...
    pip install torch-pruning==1.3.2 -i https://pypi.tuna.tsinghua.edu.cn/simple

## 视频

整体的流程说明和讲解(第一个必须要看的视频):
链接：https://pan.baidu.com/s/1gSX2O0FF9KRFZfqYe_mprw?pwd=8i6k 
提取码：8i6k  # BiliBili 魔鬼面具
